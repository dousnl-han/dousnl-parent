...
/*
    ...
    public static void main(String[] args) throws Exception {
        ...
        String aesData = AESUtils.Encrypt("{\"OperatorID\": \"313744932\", \"Operator_Secret\": \"1234567890abcdef\"}", "1234567890abcdef",
            "1234567890abcdef");
        
        System.out.println(aesData);
        
        String signData = HmacUtils.hmacMd5Hex("1234567890abcdef", "313744932" + aesData + "20160801153709").toUpperCase();
