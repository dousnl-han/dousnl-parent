...
public abstract class GreetingImplServiceCallbackHandler {
    ...
    public void receiveResultgreeting(
        com.dousnl.webservice.axisclient.GreetingImplServiceStub.GreetingResponseE result) {
    }
    ...
    public void receiveResultfindUserById(
        com.dousnl.webservice.axisclient.GreetingImplServiceStub.FindUserByIdResponseE result) {
    }
    ...
    public void receiveResultgetAllUser(
        com.dousnl.webservice.axisclient.GreetingImplServiceStub.GetAllUserResponseE result) {
    }
