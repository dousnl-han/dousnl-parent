...
import com.dousnl.annotation.LogConfig;
import com.dousnl.aop.mapper.TLogRecordMapper;
...
public class LogAopConfig {
	...
	// 定义切点Pointcut
    @Pointcut("execution(* com.dousnl.web.controller..*(..)) and @annotation(org.springframework.web.bind.annotation.RequestMapping)")
