...
public class ProxyInterfaceTest {
	...
	public static void main(String[] args) {
		...
		final ProxyInterface proxyImpl=new ProxyInterfaceImpl();
		
		ProxyInterface newProxyInstance = (ProxyInterface)Proxy.newProxyInstance(proxyImpl.getClass().getClassLoader(),
		...
		newProxyInstance.sayBay();
		System.out.println(newProxyInstance.getClass().getName());
		Class<? extends ProxyInterface> class1 = newProxyInstance.getClass();
		printClassDefinition(class1);
