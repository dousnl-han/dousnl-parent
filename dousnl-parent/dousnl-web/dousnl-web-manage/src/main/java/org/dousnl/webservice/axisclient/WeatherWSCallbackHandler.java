...
public abstract class WeatherWSCallbackHandler {
    ...
    public void receiveResultgetRegionDataset(
        org.dousnl.webservice.axisclient.WeatherWSStub.GetRegionDatasetResponse result) {
    }
    ...
    public void receiveResultgetRegionCountry(
        org.dousnl.webservice.axisclient.WeatherWSStub.GetRegionCountryResponse result) {
    }
    ...
    public void receiveResultgetWeather(
        org.dousnl.webservice.axisclient.WeatherWSStub.GetWeatherResponse result) {
    }
    ...
    public void receiveResultgetSupportCityDataset(
        org.dousnl.webservice.axisclient.WeatherWSStub.GetSupportCityDatasetResponse result) {
    }
    ...
    public void receiveResultgetRegionProvince(
        org.dousnl.webservice.axisclient.WeatherWSStub.GetRegionProvinceResponse result) {
    }
    ...
    public void receiveResultgetSupportCityString(
        org.dousnl.webservice.axisclient.WeatherWSStub.GetSupportCityStringResponse result) {
    }
